...
EXTRA_CFLAGS = -std=gnu11 -g3 -fopencilk -pthread -Werror=vla
EXTRA_LDFLAGS = -fopencilk -g3
EXTRA_HEADERS =
...
ifeq ($(GRAPHICS), 1)
	EXTRA_CFLAGS += -DGRAPHICS=1
	EXTRA_LDFLAGS += /usr/lib/x86_64-linux-gnu/libGL.so -lGLU -lglut
	STATIC_LINKING = 0
endif
